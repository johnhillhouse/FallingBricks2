...
namespace FallingBricks2.UnitTests
{
    ...
    public class ShapeIFixture
    {
        ...
        private void AssertFacingNorth(Shape shape)
        {
            ...
            Assert.AreEqual(1, shape.Tiles[3].Position.Y);
        }
        ...
        private ShapeI GetShape(int startingPointX, int startingPointY)
        {
            return new ShapeI(new Point(startingPointX, startingPointY));
        }
    }
}
